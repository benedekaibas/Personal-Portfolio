...
const Hero = () => {
  return (
    <section className="h-screen flex flex-col justify-center items-center text-center px-6" id="hero">
      <h2 className="text-4xl md:text-5xl font-bold mb-4">Hi, I'm Benedek Kaibas</h2>
      <p className="text-xl max-w-xl mb-6">
        I'm a Computer Science student at Allegheny College who is passionate about Embedded Systems, AI, and Robotics.
      </p>
